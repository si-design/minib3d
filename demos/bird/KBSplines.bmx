...
Type bbKeyFrame Extends TBBType
 ...
 Field cv#[nchannels-1+1]				'array of channel values (x y z h p b sx sy sz)
...
'------------------------------------------------------------------------
Function Apply_Motion(m:bbMotion, tstep#, e, bird_rot=0)
 ...
 RotateEntity e,icv(3),icv(4)+bird_rot,icv(5)
